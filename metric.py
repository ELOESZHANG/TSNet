...
class ROCMetric():
    ...
    def get(self):
        ...
        # f1_score = (2.0 * recall[6] * precision[6]) / (recall[6] + precision[6] + 0.00001)
...
class PD_FA():
    ...
    def update(self, preds, labels):
        # print(preds.shape) #torch.Size([4, 1, 512, 512])
        for iBin in range(self.bins + 1):
            ...
            # print("coord",len(coord_image),len(coord_label))
...
def cal_tp_pos_fp_neg(output, target, nclass, score_thresh):
    ...
    neg = fp + tn
    class_pos = tp + fp
    # print("metric tp",tp,"fp",fp,"tn",tn,"fn",fn)
